...
const Hero = () => {
  return (
    <section className="w-full pt-20 pb-10" id="home">
      <div className="w-full px-6 sm:px-12 flex flex-col justify-center items-center gap-10 text-center ">
        <h1 className="w-full lg:max-w-6xl font-headings leading-15 md:leading-20 lg:leading-28 text-6xl sm:text-6xl md:text-7xl lg:text-8xl">
          I want to{" "}
